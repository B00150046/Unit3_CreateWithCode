...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayerControllerX_Update_mE690DFA5B4D44A839AC48EC903E382790B5CCC8B (PlayerControllerX_tF9D775557FE097FA08B4768B1295EA527AFF0D2B* __this, const RuntimeMethod* method) 
{
	...
	{
		__this->___lowEnough = (bool)0;
		goto IL_0027;
	}

IL_0020:
	{
		__this->___lowEnough = (bool)1;
	}
...
IL_0050:
	{
		...
		bool L_10;
		L_10 = GameObject_CompareTag_m6378BE50D009A93D46036F74CC3F7E2ECB0636E5(L_9, _stringLiteral7A65EFC5BB52048E35B0D3E2214BCF8CE116440A, NULL);
		if (!L_10)
		{
			goto IL_009c;
		}
	...
	}
	{
		...
		AudioClip_t5D272C4EB4F2D3ED49F1C346DEA373CF6D585F20* L_16 = __this->___bounce;
		AudioSource_PlayOneShot_mF6FE95C58996B38EF6E7F7482F95F5E15E0AB30B(L_15, L_16, (1.5f), NULL);
		return;
	}
...
IL_009c:
	{
		...
		bool L_19;
		L_19 = GameObject_CompareTag_m6378BE50D009A93D46036F74CC3F7E2ECB0636E5(L_18, _stringLiteral4783348997FD98C18DE1576BBDFDC07F874F5EE3, NULL);
		if (!L_19)
		{
			goto IL_00da;
		}
	...
	{
		ParticleSystem_tB19986EE308BD63D36FB6025EEEAFBEDB97C67C1* L_20 = __this->___fireworksParticle;
		...
		AudioClip_t5D272C4EB4F2D3ED49F1C346DEA373CF6D585F20* L_22 = __this->___moneySound;
		AudioSource_PlayOneShot_mF6FE95C58996B38EF6E7F7482F95F5E15E0AB30B(L_21, L_22, (1.0f), NULL);
		Collision_tBCC6AEBD9A63E6DA2E50660DAC03CDCB1FF7A9B0* L_23 = ___0_other;
